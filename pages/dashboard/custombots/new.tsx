        ...
        case 2: // Step 3 (Add Redirect url)
            return (
                <>
                    ...
                    <Typography variant="body1" sx={{ mb: 2, color: "text.secondary" }}>Go to your Application&apos;s OAuth2 page and add the following redirect URL:<br/><code onClick={() => { try { navigator.clipboard.writeText("https://slotty.cc/api/callback"); setNotification({ ...notification, info: { open: true, text: "Copied to clipboard!" } }); } catch {} }} style={{ cursor: "pointer" }}>https://slotty.cc/api/callback</code></Typography>
