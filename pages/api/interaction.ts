...
const handler = async(_: NextApiRequest, res: NextApiResponse, interaction: any) => {
    ...
    if (type === 2) {
        ...
        case "pull":
            ...
            var roles = await axios.get(`https://discord.com/api/v10/guilds/${interaction.guild_id}/roles`, { headers: { Authorization: `Bot ${customBot.botToken}` }, proxy: false, httpsAgent: new HttpsProxyAgent(`http://${process.env.PROXY_USERNAME}:${process.env.PROXY_PASSWORD}@brd.superproxy.io:33335`) })
        ...
        case "verify-embed":
            ...
            let server = await axios.get(`https://discord.com/api/v10/guilds/${interaction.guild_id}`, { headers: { Authorization: `Bot ${customBot.botToken}` }, validateStatus: () => true, proxy: false, httpsAgent: new HttpsProxyAgent(`http://${process.env.PROXY_USERNAME}:${process.env.PROXY_PASSWORD}@brd.superproxy.io:33335`) });
            let nWebhook = await axios.post(`https://discord.com/api/v10/channels/${options[0].value}/webhooks`, { name: "Verification" }, { headers: { Authorization: `Bot ${customBot.botToken}` }, validateStatus: () => true, proxy: false, httpsAgent: new HttpsProxyAgent(`http://${process.env.PROXY_USERNAME}:${process.env.PROXY_PASSWORD}@brd.superproxy.io:33335`) });
            ...
            if (nWebhook.status !== 200) {
                await axios.patch(`https://discord.com/api/webhooks/${interaction.application_id}/${interaction.token}/messages/@original`, {
                    ...
                    embeds: [{
                        title: "❌ Error",
                        description: nWebhook.data.message ?? "An error occured while trying to create the webhook, please try again later. and [contact support](https://t.me/SlottyRecovery) if the issue persists.",
                        color: 0xff0000
                    }],
                    flags: InteractionResponseFlags.EPHEMERAL
                }, {
            ...
            await axios.post(`https://discord.com/api/webhooks/${webhook.id}/${webhook.token}`, {
                ...
                await axios.patch(`https://discord.com/api/webhooks/${interaction.application_id}/${interaction.token}/messages/@original`, {
                    ...
                    embeds: [{
                        title: "❌ Error",
                        description: "The embed has not been sent successfully. Contact SlottyRecovery staff: https://t.me/SlottyRecovery",
                        color: 0xff0000
                    }],
                    flags: InteractionResponseFlags.EPHEMERAL
                }, {
        ...
        case "skip_verify":
            ...
            await axios.put(`https://discord.com/api/v10/guilds/${interaction.guild_id}/members/${interaction.member.user.id}/roles/${serverInfo.roleId}`, {}, {
                ...
                console.error(err);
                return res.status(200).json({ ...BASE_RESPONSE, data: { content: "An error occured while trying to give the verified role, please try again later. and [contact support](https://t.me/SlottyRecovery) if the issue persists.", flags: InteractionResponseFlags.EPHEMERAL } });
            });
        ...
        case "pull_server_2":
            ...
            var dscServer = await axios.get(`https://discord.com/api/v10/guilds/${interaction.guild_id.toString()}`, { headers: { Authorization: `Bot ${bot.botToken}` }, proxy: false, httpsAgent: new HttpsProxyAgent(`http://${process.env.PROXY_USERNAME}:${process.env.PROXY_PASSWORD}@brd.superproxy.io:33335`) })
        ...
        case custom_id.startsWith("pull_server_3") && custom_id:
            ...
            await axios.get(`https://discord.com/api/v10/guilds/${interaction.guild_id}`, {
                ...
                console.error(err);
                return res.status(200).json({ type: 4, data: { content: "An error occured while trying to pull members from the server, please try again later. and [contact support](https://t.me/SlottyRecovery) if the issue persists.", flags: InteractionResponseFlags.EPHEMERAL } });
            });
            ...
            if (roleId !== "null" && roleId !== "undefined") {
                await axios.put(`https://discord.com/api/v10/guilds/${interaction.guild_id}/members/${bot.clientId}/roles/${roleId}`, {}, {
                    ...
                    console.error(err);
                    return res.status(200).json({ type: 4, data: { content: "An error occured while trying to give the verified role, please try again later. and [contact support](https://t.me/SlottyRecovery) if the issue persists.", flags: InteractionResponseFlags.EPHEMERAL } });
                });
            }
