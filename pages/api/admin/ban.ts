                            ...
                            <div style="padding: 1rem; max-width: 50rem; margin-left: auto;margin-right: auto; width: 100%; border-radius: 0.75rem; border-width: 1px; background: rgb(250, 250, 250);">
                                ...
                                <div>
                                    <p style="white-space: pre-line; color: rgb(0, 0, 0); font-weight: 400; margin-bottom: 0.75rem; overflow-wrap: break-word; font-size: 1rem;">
                                        ...
                                        <br>Your account on SlottyRecovery has been suspended for violating our Terms of Service or Community Guidelines.
                                        <br>Reason for suspension: ${banReasons.find(r => r.id === reason)?.message}
                                        <br>If you believe your account was suspended in error, or have any questions or concerns, please contact us at <a href="mailto:support@slotty.cc">support@slotty.cc</a>.
                                        <br>Sincerely,
                                        SlottyRecovery Trust & Safety Team
                                    </p>
                                </div>
                                <div style="text-align: center; margin-top: 1rem;">
                                    <em style="color: rb(190, 198, 213)">
                                        Copyright &#169; 2024 SlottyRecovery. All rights reserved.
                                    </em>
                                </div>
                            </div>
                        </body>
