        ...
        if (payment) {
            ...
            if (subscription) {
                const session = await stripe.billingPortal.sessions.create({
                    return_url: `https://slotty.cc/dashboard/upgrade`,
            ...
            if (payment && (user.role !== "free" && user.expiry)) {
                ...
                const charge = await Charge.create({
                    name: "SlottyRecovery Subscription",
                    description: `SlottyRecovery ${plan} Subscription Upgrade`,
                    local_price: {
                    ...
                    redirect_url: `https://slotty.cc/dashboard/upgrade?s=2`,
                    cancel_url: `https://slotty.cc/dashboard/upgrade?c=1`,
                });
