...
async function handler(req: NextApiRequest, res: NextApiResponse, user: accounts) {
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            success_url: `https://slotty.cc/api/stripe/payment?success=true&session_id={CHECKOUT_SESSION_ID}`,
            cancel_url: `https://slotty.cc/api/stripe/payment?canceled=true`,
            ...
            ...(req.body.klarna || req.body.giropay ? {
                ...
                subscription_data: {
                    description: `SlottyRecovery Subscription`,
                    metadata: {
                        account_id: user.id,
                        plan: plan,
                    },
            ...
            ...(req.body.klarna && req.body.giropay && { 
                payment_intent_data: {
                    ...
                    statement_descriptor: `SlottyRecovery ${plan === "premium" ? "Premium" : "Business"}`,
                },
            }),
            tax_id_collection: {
                enabled: true,
