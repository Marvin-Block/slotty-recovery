                ...
                <DialogContent>
                    ...
                    {user.bots.find((bot: any) => bot.clientId === id).customDomain ? (
                        ...
                        <>
                            <DialogContentText id="alert-dialog-description">
                                <Typography variant="body1">
                                    You can set a custom domain to your bot. This will allow you to use your own domain for your bot, instead of using slotty.cc.
                                </Typography>
                                ...
                                {(customDomainSettings.verification.name || customDomainSettings.validation.name || customDomainSettings.status === "pending") && (
                                    <>
                                        ...
                                        <Typography variant="body1" sx={{ mt: 1 }}><b>Value:</b> <CodeCopy>fallback.slotty.cc</CodeCopy></Typography>
                                    </>
                                )}
                            </DialogContentText>
                            <DialogActions>
                            ...
                            <>
                                ...
                                <form onSubmit={handleSubmit}>
                                    <Grid container spacing={3} direction="column">
                                        ...
                                        <Grid item>
                                            <Typography variant="h6" sx={{ mb: 2, fontWeight: "500" }}>
                                                Custom Domain <small><small>(optional)</small> <a href="https://docs.slotty.cc/guides/custom-domain/" target="_blank" rel="noreferrer">[Learn More]</a></small>
                                            </Typography>
