                            ...
                            <>
                                {(!botClient.loading && !botClient.valid) && (
                                    <Alert severity="warning" sx={{ my: "1rem" }}>
                                        <Typography variant="body1" sx={{ fontWeight: "400" }}>Your bot has an Invalid Token, usually this means that the Bot was deleted/disabled by Discord, or the token was changed. <Link href="https://docs.slotty.cc/troubleshooting/invalid-token" target="_blank" rel="noreferrer">Learn More</Link></Typography>
                                    </Alert>
                                )}
                                ...
                                <form onSubmit={(e) => e.preventDefault()}>
                                    {server.authorizeOnly && (
                                        <Alert severity="error" sx={{ mb: "1rem" }}>
                                            ...
                                            You have enabled the &quot;Authorize Only&quot; feature, this means that SlottyRecovery will only add the member to your Database, <b>bypass any blacklists</b>, and will <b>NOT</b> give them the Verified Role or send a message to the Webhook URL.
                                        </Alert>
                                    )}
                                                    ...
                                                    {!newServer.nsfw && (
                                                        <Stack direction="row">
                                                            ...
                                                            {user.role !== "business" && user.role !== "enterprise" ? (
                                                                ...
                                                                <Tooltip arrow placement="top" title="If enabled, your server will be shown on the SlottyRecovery Discovery page, located at https://slotty.cc/discovery.">
                                                ...
                                                <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", height: "50vh", flexDirection: "column" }}>
                                                    <Paper sx={{ borderRadius: "1rem", padding: "2rem", marginTop: "1rem", width: { xs: "100%", md: "75%" }, marginBottom: "2rem", boxShadow: "0px 10px 10px 5px rgba(0, 0, 0, 0.25)", backgroundColor: "#00000026", backdropFilter: "blur(1.5rem)" }}>
                                                        <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "row", textAlign: "center", width: "100%" }}>
                                                            ...
                                                            {newServer.verified && (
                                                                <Tooltip TransitionComponent={Fade} TransitionProps={{ timeout: 200 }} placement="top" disableInteractive title={`This server has been verified by SlottyRecovery and is deemed to be safe and legitimate.`}>
                                        ...
                                        <Stack direction="column" spacing={2}>
                                            ...
                                            <Stack direction="row">
                                                ...
                                                {user.role !== "enterprise" ? (
                                                    ...
                                                    <Tooltip arrow placement="top" title="If enabled, SlottyRecovery will ONLY add the member to your Database, and will not give them the Verified Role or send a message to the Webhook URL.">
                                                        <InfoIcon sx={{ fontSize: "1rem", alignSelf: "center", ml: "0.25rem" }} />
                                                    </Tooltip>
                                                )}
                                            ...
                                            <Stack direction="row">
                                                ...
                                                {user.role === "free" ? (
                                                    ...
                                                    <Tooltip arrow placement="top" title="If enabled, SlottyRecovery will send a message to the specified Webhook URL when a user verifies.">
                                                        <InfoIcon sx={{ fontSize: "1rem", alignSelf: "center", ml: "0.25rem" }} />
                                                    </Tooltip>
                                                )}
                                            ...
                                            <Stack direction="row">
                                                ...
                                                {user.role === "free" ? (
                                                    ...
                                                    <Tooltip arrow placement="top" title="If enabled, SlottyRecovery will block users from verifying if they are using a VPN or Proxy (Residential VPNs may not be blocked due to them being real IP Addresses).">
                                                        <InfoIcon sx={{ fontSize: "1rem", alignSelf: "center", ml: "0.25rem" }} />
                                                    </Tooltip>
                                                )}
                                            ...
                                            <Stack direction="row">
                                                ...
                                                {user.role === "free" ? (
                                                    ...
                                                    <Tooltip arrow placement="top" title="If enabled, SlottyRecovery will check if the User has verified with the same IP Address before, and if so, will block them from verifying again.">
                                                        <InfoIcon sx={{ fontSize: "1rem", alignSelf: "center", ml: "0.25rem" }} />
                                                    </Tooltip>
                                                )}
                                            ...
                                            <Stack direction="row">
                                                ...
                                                {user.role !== "enterprise" ? (
                                                    ...
                                                    <Tooltip arrow placement="top" title="If enabled, SlottyRecovery will block users from using a Wireless IP Address (LTE, 4G, 5G) to verify.">
                                                        <InfoIcon sx={{ fontSize: "1rem", alignSelf: "center", ml: "0.25rem" }} />
                                                    </Tooltip>
                                                )}
                                            ...
                                            <Stack direction="column">
                                                <Stack direction="row">
                                                    ...
                                                    {user.role !== "enterprise" ? (
                                                        ...
                                                        <Tooltip arrow placement="top" title="If enabled, SlottyRecovery will block users from verifying if their Discord Account is younger than the specified amount of days.">
                                                            <InfoIcon sx={{ fontSize: "1rem", alignSelf: "center", ml: "0.25rem" }} />
                                                        </Tooltip>
                                                    )}
                                                </Stack>
